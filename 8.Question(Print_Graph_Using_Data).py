...
data = [{"_id":0,"name":"aimee Zank","scores":[{"score":1.463179736705023,"type":"exam"},{"score":11.78273309957772,"type":"quiz"},{"score":35.8740349954354,"type":"homework"}]}
...
plt.bar(names, exam_scores, label="Exam")
plt.bar(names, quiz_scores, bottom=exam_scores, label="Quiz")
plt.bar(names, homework_scores, bottom=[x + y for x, y in zip(exam_scores, quiz_scores)], label="Homework")
